package com.custom.postprocessing.constant;
...
public class PostProcessingConstant {
	...
	public static final String ACCOUNT_KEY_VALUE = "DefaultEndpointsProtocol=https;AccountName=pmapostprcoessing1;AccountKey=m2cIK0WnmiBa0HO1GBZMKl9NRomWr3tzWyP+IHQnmjO6yrQu7j8s4EWbyqH/x1tfyCffshjLCqyyWWw7cEYdlw==";
	public static final String CONTANIER_NAME = "sc-output";
}
